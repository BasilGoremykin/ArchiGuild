...
### Бизнес-метрики
- Уровень удовлетворенности участников - 85% положительных оценок
- Количество докладчиков - 100 докладчиков на конференцию
- Скорость рассмотрения заявок на доклад - 95% заявок обрабатываются в течение 7 дней
- Количество успешно проведенных докладов - 95% докладов проводятся без технических проблем
- Процент просмотренных трансляций - 80% зарегестрированных участников смотрят трансляции докладов
