...
### Бизнес-метрики 
- Оперативность обработки заявок: 90% заявок на доклад обрабатываются в течение 7 дней
- Масштабность конференции: 100 докладчиков на конференции
- Доступность материалов после окончания конференции: возможность просмотра докладов в записи в течении месяца после окончания конференции
- Обеспечение охватности за счет отправки уведомлений: зритель получит уведомление о проведении доклада за 3 часа
- Сбор обратной связи: 70% зрителей оставили обратную связь о докладе

### Нефункциональные требования/Показатели качества
| Нефункциональное требование                                                           | Показатель качества                                                                                                                                                 |
|---------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Процесс авторизации пользователя - не более 30 секунд                                 | Время получения ответа от сервиса авторизации не более 20 секунд во время отсутствия проведения докладов и не более 30 секунд в 5ти минутное окно от начала доклада |
